...
import com.packy.designpattern.memento.commands.ColorCommand;
import com.packy.designpattern.memento.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.packy.designpattern.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
